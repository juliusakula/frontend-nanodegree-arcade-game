 ...
 * @extends Enemy
 */
var CentipedeSidestepper = function () {
    Enemy.call(this);
    this.width = 270;
    this.sideStepSpeed = 0;
    this.newY = this.y;
    this.sprite = 'images/centipede-sidestepper.png';
    this.sidestep();
};

CentipedeSidestepper.prototype = Object.create(Enemy.prototype);
CentipedeSidestepper.prototype.constructor = CentipedeSidestepper;
 ...
 * @param {number} dt Time between each execution of main function.
 */
CentipedeSidestepper.prototype.update = function (dt) {
    Enemy.prototype.update.call(this, dt);
    if (!gamestate.paused) {
        this.y += dt * this.sideStepSpeed * gamestate.speed;
        // If this sidestepper has reached or passed its target row,
 ...
 * down.
 */
CentipedeSidestepper.prototype.sidestep = function () {
    // self is used to access this inside the setInterval function.
    var self = this;
    var steppingInterval = randInt(1000, 3000);
    var newY;
